...
/**
 * The last thing a visitor sees when something unexpected fails. It gives
 * them the one address that can actually help, because a bare "Application
 * error" at a festival booth is a dead end.
 */
